...
zf = zipfile.ZipFile(os.path.join(OUT, 'dongle-pro-power-gerbers-jlcpcb.zip'), 'w',
...
subprocess.run(['kicad-cli', 'pcb', 'export', 'step', '--subst-models',
                '-o', os.path.join(OUT, 'dongle-pro-power.step'), PCB], check=False)
...
LCSC = {
    ...
    '25MHz': 'C9006',
    # power section (Pro-Power)
    'STUSB4500QTR': 'C2678061', 'LM74800QDRRRQ1': 'C3215600',
    'NVMFD5853NL': 'C5148672', 'TPS54331DR': 'C9865',
    'INA180A1IDBVR': 'C122228', 'SS34_C8678': 'C8678',
    'SMBJ24A-C87268': 'C87268', '10mR-2512': 'C2903468',
    '10uH': 'C182189', '10nF': 'C15195', '3.3nF': 'C26404',
    '470R': 'C25117', '54.9k': 'C137959',
}
MPN = {'25MHz': 'X322525MOB4SI', 'TPD4E05U06DQAR_C138714': 'TPD4E05U06DQAR',
       'SS34_C8678': 'SS34', 'SMBJ24A-C87268': 'SMBJ24A',
       '10mR-2512': 'HoJieLe HOJLR2512-3W-10MR-1%', '10uH': 'Sunltech SLW5040S100MST',
       '54.9k': 'Yageo RC0402FR-0754K9L'}
SKIP_PREFIX = ('TP', 'J3')
