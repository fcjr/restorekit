#!/usr/bin/env python3
"""Build dongle-pro-power.kicad_pcb from the board-usb3.py netlist.
...
X0, Y0, X1, Y1 = 96.0, 99.0, 138.0, 197.0
P = {
 ...
 "J2": (109.0, 191.9, 0),
 # ===== power strip (x 122-134), north to south =====
 "L3": (127.6, 123.5, 90), "U14": (128.0, 116.0, 180),
 "C68": (123.6, 111.0, 180), "C69": (123.6, 114.0, 180),
 "C70": (125.2, 129.0, 90), "C71": (126.9, 129.0, 90), "C72": (128.6, 129.0, 90),
 "R28": (124.9, 116.5, 270), "R29": (124.9, 118.9, 270),
 "R30": (121.9, 131.5, 270), "R31": (121.9, 134.0, 270),
 "R32": (124.0, 122.5, 90), "C66": (124.0, 125.0, 90),
 "C67": (131.4, 116.8, 90), "C65": (131.5, 120.9, 90),
 "D21": (121.3, 146.6, 90), "D22": (124.5, 101.2, 0),
 "U11": (128.0, 135.0, 0), "C60": (123.6, 132.0, 90), "C61": (123.6, 135.0, 90),
 "C62": (131.6, 133.6, 90), "R37": (120.6, 134.5, 90),
 "R41": (123.6, 138.0, 90), "R42": (128.4, 141.2, 0),
 "J4": (128.9, 148.0, 270),
 "D23": (124.0, 141.5, 180),
 # 20V switch zone
 "Q1": (128.8, 159.0, 270), "Q2": (128.8, 166.2, 90),
 "U12": (134.1, 162.6, 90),
 "C63": (133.35, 159.5, 90), "C73": (122.3, 161.0, 90), "R38": (122.3, 163.5, 90),
 # sense zone
 "R26": (130.0, 172.0, 0), "U15": (126.8, 175.4, 0),
 "D24": (135.0, 182.3, 90),
 "R33": (122.3, 165.5, 90), "R34": (122.3, 167.8, 90),
 # discharge
 "Q5": (129.8, 179.6, 90),
 "R35": (122.3, 170.1, 90), "R36": (122.3, 172.4, 90), "R40": (135.5, 170.0, 90),
 # vSafe switch zone
 "D20": (122.6, 180.2, 90),
 "Q3": (128.8, 185.6, 270), "Q4": (128.8, 192.0, 90),
 "U13": (134.1, 189.2, 90),
 "C64": (133.35, 186.0, 90), "C74": (122.3, 190.0, 90), "R39": (122.3, 192.5, 90)}

board = pcbnew.CreateEmptyBoard()
board.SetFileName(os.path.abspath('dongle-pro-power.kicad_pcb'))
...
pcbnew.SaveBoard('dongle-pro-power.kicad_pcb', board)
